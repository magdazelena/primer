...
jest.mock("@strapi/design-system", () => {
          ...
          children: Array.isArray(children)
            ? children.filter(Boolean).map((child, index) => {
                ...
                return child && typeof child === "object"
                  ? { ...child, key: child.key || `child-${index}` }
                  : child;
              })
            : children,
        },
          ...
          ? children
              ...
              .map((child, index) =>
                child && typeof child === "object"
                  ? { ...child, key: child.key || `trigger-child-${index}` }
                  : child,
              )
          : children,
      },
      ...
      props: {
        ...
        children: Array.isArray(children)
          ? children
              ...
              .map((child, index) =>
                child && typeof child === "object"
                  ? { ...child, key: child.key || `content-child-${index}` }
                  : child,
              )
          : children,
      },
      ...
      props: {
        ...
        children: Array.isArray(children)
          ? children
              ...
              .map((child, index) =>
                child && typeof child === "object"
                  ? { ...child, key: child.key || `header-child-${index}` }
                  : child,
              )
          : children,
      },
      ...
      props: {
        ...
        children: Array.isArray(children)
          ? children
              ...
              .map((child, index) =>
                child && typeof child === "object"
                  ? { ...child, key: child.key || `body-child-${index}` }
                  : child,
              )
          : children,
      },
      ...
      props: {
        ...
        children: Array.isArray(children)
          ? children
              ...
              .map((child, index) =>
                child && typeof child === "object"
                  ? { ...child, key: child.key || `footer-child-${index}` }
                  : child,
              )
          : children,
      },
      ...
      props: {
        ...
        children: Array.isArray(children)
          ? children
              ...
              .map((child, index) =>
                child && typeof child === "object"
                  ? { ...child, key: child.key || `cancel-child-${index}` }
                  : child,
              )
          : children,
      },
      ...
      props: {
        ...
        children: Array.isArray(children)
          ? children
              ...
              .map((child, index) =>
                child && typeof child === "object"
                  ? { ...child, key: child.key || `action-child-${index}` }
                  : child,
              )
          : children,
      },
  ...
  return {
    ...
    Box({ children, ref, padding, ...props }) {
      const { marginTop, marginBottom, alignItems, fullWidth, ...restProps } =
        props;
      return createStyledElement(
        ...
        Array.isArray(children)
          ? children.map((child, index) =>
              typeof child === "object"
                ? { ...child, key: child.key || `box-child-${index}` }
                : child,
            )
          : children,
      );
    ...
    SingleSelectOption: ({ children, ref, value, ...props }) =>
      createStyledElement(
        "option",
        {
          ...props,
    ...
    NumberInput: ({ label, value, onValueChange, ...props }) =>
    ...
    MultiSelect: ({ value, onChange, placeholder, children, ...props }) =>
      createStyledElement("div", {
        ...props,
        children: [
          createStyledElement("input", {
    ...
    MultiSelectOption: ({ children, value, ...props }) =>
      createStyledElement(
        "option",
        {
          ...props,
